...
# this is the ui file for detecting motion in video and creating a single enhanced video file
# without audio
class Window(QtGui.QMainWindow):
    ...
    # set total no of frames on the ui
    ...
    # play the video with the motion algorithm
    ...
    # call the motion detection algorithm
    def callMotionDetection(self):
        ...
        if threshold and inputFile and outputFile:
            noaudio.startProcessing(self, inputFile, outputFile, threshold)
        else:
            pass
